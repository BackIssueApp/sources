// MangaTaro download source plugin for BackIssue.
//
...
import { mangataro } from './source.js';

export default function register(api) {
  if (typeof api.defineSource !== 'function') {
    throw new Error('The MangaTaro plugin needs BackIssue 0.8.2 or newer (it uses api.defineSource).');
  }
  api.defineSource(mangataro);
}
